...
export const charities = [
  {
    ...
    stripe_account_id: 'acct_demo_charity_1', // Demo account ID
  ...
  },
  {
    ...
    verified: true,
    // Stripe Connect fields
    stripe_account_id: 'acct_demo_charity_2', // Demo account ID
    stripe_onboarding_complete: true,
    charges_enabled: true,
    payouts_enabled: true,
    platform_fee_percent: 2.5,
  ...
  },
  {
    ...
    founded: 2016,
    verified: false,
    // Stripe Connect fields - Not verified yet
  ...
  },
  {
    ...
    verified: true,
    // Stripe Connect fields
    stripe_account_id: 'acct_demo_charity_4',
    stripe_onboarding_complete: true,
    charges_enabled: true,
    payouts_enabled: true,
    platform_fee_percent: 2.5,
  ...
  },
  {
    ...
    verified: true,
    // Stripe Connect fields
    stripe_account_id: 'acct_demo_charity_5',
    stripe_onboarding_complete: true,
    charges_enabled: true,
    payouts_enabled: true,
    platform_fee_percent: 2.5,
